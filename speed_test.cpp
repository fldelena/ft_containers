...
/*
  ...
  /* 
    start_time = clock();
    {
        ...
        std::allocator<int>::pointer v1PtrA = v1Alloc.address(*std::find(v1.begin(), v1.end(), 6));
        std::allocator<int>::pointer v2PtrA = v1Alloc.address(*std::find(v1.begin(), v1.end(), 15));
